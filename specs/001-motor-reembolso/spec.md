...
Esta seção documenta, de forma normativa e verificável sem leitura de código, os quatro cenários financeiros completos do envelope do Dia 2 — a contraparte da `§4.7` para a política v4. Todos os valores abaixo foram calculados manualmente a partir das regras desta spec (RN-019 a RN-022 e as regras da linha de base atualizadas) e posteriormente confirmados pela execução do motor, que implementa esta versão.
