...
- [x] **T-041** — `AvaliadorRegrasIndividuais` consome política externa
...
- [x] **T-049** — Serializar campos de câmbio em `EscritorResultado` e migrar o fixture histórico para o schema 1.2
...
- [x] **T-055** — Migrar consumidores restantes de `PoliticaReembolso`, `AgregadorTetoHospedagem` e do construtor de compatibilidade de `ItemValidado`
