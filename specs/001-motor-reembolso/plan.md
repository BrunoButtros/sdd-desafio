...
| RN-009 (atualizada) · CA-032 | `ConversaoCambialIntegracaoTest` — gatilho aplicado sobre o valor já convertido (USD 40,00 → R$220,00 sem nota → recusado), não o valor original na moeda da despesa | Unidade |
